...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    try {
      ...
      // Call addDummyData instead of fetching from Firebase
      initproductProvider.addDummyData();
                  ...
                  MaterialPageRoute(
                    builder: (context) => Search(
                        search: productProvider
                            .getAllProductSearch), // Correctly using getAllProductSearch
                  ),
                );
              },
              icon: Icon(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: AssetImage(
                      'lib/assets/fruits/Oranges.jpg'), // Updated to use one of your fruit images as banner
                ),
                color: Colors.red,
